...
void merge(vector<int> &value, int startLeft, int endLeft, int startRight, int endRight)
{
...
void MergeSort::merge_sort(vector<int> &value, int startIndex, int endIndex)
{
